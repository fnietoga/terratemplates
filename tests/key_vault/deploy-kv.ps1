...
$clientKey = Get-Secret -Name 'fnieto_fnietokabel-deploy' -AsPlainText #see https://devblogs.microsoft.com/powershell/secretmanagement-and-secretstore-are-generally-available/
